...
_DNNL_RUNTIME_OMP = {
    ...
    "#cmakedefine01 BUILD_TRAINING": "#define BUILD_TRAINING 0",
    "#cmakedefine01 BUILD_INFERENCE": "#define BUILD_INFERENCE 1",
    ...
    "#cmakedefine01 BUILD_AVX512": "#define BUILD_AVX512 1",
